...
@section('content')
    ...
    <section class="about w-100 d-flex" id="intro">
        <div class="about-text ">
            <video class="videoIntro" controls>
                    <source class="videoIntro text-center" src="img/banners/videoEx3.mp4" type="video/mp4" >
            </video>   
        </div>
        <div class="about-text">
            <h2 class="titles text-center px-0">Introdução</h2>
    ...
    <section class="about2 w-100 d-flex" id="about">
        <div class="buscamos">
            <h2 class="titles text-center px-0">O que buscamos?</h2>
            <p class="lead" >Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos,
                e vem sendo utilizado desde o século XVI, quando um impressor desconhecido pegou uma bandeja
                de tipos e os embaralhou para fazer um livro de modelos de tipos.
            </p>
        ...
        <div class="vida">
            <h2 class="titles text-center px-0">Como mudou minha vida?</h2>
            <p class="lead" >Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos,
                e vem sendo utilizado desde o século XVI, quando um impressor desconhecido pegou uma bandeja
                de tipos e os embaralhou para fazer um livro de modelos de tipos.
            </p>
    ...
    <section class="history w-100 d-flex" id="history">
        <div class="boxHistory container-fluid px-0">
            <h2 class="titles text-center mt-5 mb-5 px-0" >History</h2>
            <div class="HistoryRight row" style="background-color: #f1f2f4;">
                <div class="ourHistory col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <img src="img/userIcon.png" class="historyImg"  data-aos="slide-right" alt="pdto 05">
                </div>
                <!-- {{-- <h1 class="titles2">O que Perguntar  ?</h1> --}} -->
                <p class="textHistoryRight lead col-xs-12 col-sm-8 col-md-8 col-lg-8" >Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos,  e vem sendo utilizado desde o século XVI, quando um impressor desconhecido pegou uma bandeja
            ...
            <br>
            <div class="HistoryRight mb-5 row" style="background-color: #f1f2f4;">
                <div class="ourHistory col-xs-12 col-sm-4 col-md-4 col-lg-4">
                    <img src="img/userIcon.png" class="historyImg"  data-aos="slide-right" alt="pdto 05">
                </div>
                <!-- {{-- <h1 class="titles2">O que Perguntar  ?</h1> --}} -->
    ...
    <section class="business w-100 d-flex" id="business">
        <div class="container-fluid" style="background-color: #f1f2f4;">
            <h2 class="titles text-center mt-5 mb-5 px-0">Modelo de Negócio</h2>
            <div class="row ">
                <p class="lead text-center col-xs-12 col-sm-12 col-md-12 col-lg-12" >Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos,
                    e vem sendo utilizado desde o século XVI, quando um impressor desconhecido pegou uma bandeja
                    de tipos e os embaralhou para fazer um livro de modelos de tipos.
                </p>
            </div>
            <div class="col-12  col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center mt-3 mb-5">
                <video class="videoBusiness" controls>
                    <source class="videoBusiness text-center" src="img/banners/videoEx3.mp4" type="video/mp4" >
                </video>   
            </div>
        </div>
        <hr class="Separador">
    ...
    <section class="business w-100 d-flex" id="witness">
        <div class="container-fluid p-0" style="background-color: #f6f6f6;">
            <h2 class="titles text-center mt-4 mb-3 px-0">Testemunhos</h2>
            <div class="carousel slide" data-ride="carousel">
                ...
                <div class="container-fluid" id="why">
                    <h2 class="text-center mt-3 mb-3">Por que sim e Não?</h2>
                    <div class="row ">
                        <p class="lead text-center col-xs-12 col-sm-12 col-md-12 col-lg-12" >Lorem Ipsum é simplesmente uma simulação de texto da indústria tipográfica e de impressos, 
                            e vem sendo utilizado desde o século XVI, quando um impressor desconhecido pegou uma bandeja 
                            de tipos e os embaralhou para fazer um livro de modelos de tipos. Lorem Ipsum sobreviveu não 
                ...
                <div class="container-fluid">
                    <nav class="row">
                        <div class="col-12  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <p class="text-center">
                                <iframe class="videoWhy" width="560" height="315" src="https://www.youtube.com/embed/gEHjgZ_z5Z4" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            ...
                            <p class="text-center">
                                <iframe class="videoWhy" width="560" height="315" src="https://www.youtube.com/embed/uAYDG14JpPs" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            ...
                            <p class="text-center">
                                <iframe class="videoWhy" width="560" height="315" src="https://www.youtube.com/embed/abhno9F8cyY" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        ...
        <div class="container-fluid" style="background-color: #f1f2f4;">
            <div class="row">
                <div class="text-center col-12  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <h1 class="titles px-0">No Mundo</h1>
                </div>
                <div class="text-center mt-3 col-12  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <img class="firstNewsIMG"text-center src="{{url('img/Banners/News/news1')}}.jpg" width="150">
                </div>  
                <div class="text-center col-12  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <br>
                <br>
                <div class="text-center mt-4 mb-0 col-12  col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <p class="secondNewsIMG textWorld lead" text-center >Lorem Ipsum é Expansão.
                    </p>
    ...
    <section id="photos">
        <div class="container-fluid" style="background-color: #f6f6f6;">
            <div class="row">
                <div class="text-center col-12  col-xs-12 col-sm-12 col-md-12 col-lg-12 px-0">
                    <h1 class="titles px-0">Fotos e Fatos</h1>
                </div>
                    <div class="photosImgs container-fluid px-0" >
                            <div class="row">
                            <article  class="marcas col-6 col-sm-4 col-md-4 col-lg-2">
